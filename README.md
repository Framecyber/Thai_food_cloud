...
## เว็บแอปพลิเคชันสำหรับสั่งอาหารไทยแบบ Fullstack พัฒนาด้วย Angular frontend และ Spring Boot backend
...
```bash
git clone https://github.com/yourusername/Thai_food_cloud.git
cd Thai_food_cloud
```
